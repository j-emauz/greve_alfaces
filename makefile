...
greve: main.o comboios.o ler.o SDL_comboios.o
	gcc -g -I/usr/include/SDL2 -D_REENTRANT -Wall -pedantic -std=c99 -L/usr/bin/sdl2-config main.o comboios.o ler.o SDL_comboios.o  -lm -lSDL2 -lSDL2_image -lSDL2_gfx -o greve 
